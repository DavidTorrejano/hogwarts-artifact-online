...
public class ExceptionHandlerAdvice {
    ...
    Result handleAuthenticationException(Exception ex){
        return new Result(false, StatusCode.UNAUTHORIZED, "Username or password incorrect", ex.getMessage());
    }
    ...
    Result handleInvalidBearerTokenException(InvalidBearerTokenException ex){
        return new Result(false, StatusCode.UNAUTHORIZED, "The access token provided" +
                " is expired, revoked, malformed or invalid for other reasons.", ex.getMessage());
    }
    ...
    // Here we are going to define a handler for all the exceptions not mentioned before
