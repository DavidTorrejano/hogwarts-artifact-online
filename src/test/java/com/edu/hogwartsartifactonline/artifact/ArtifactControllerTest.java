...
class ArtifactControllerTest {
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        // When & Then
        mockMvc.perform(MockMvcRequestBuilders.put(baseUrl + "/artifacts/1250808601744904192")
                        .contentType(MediaType.APPLICATION_JSON).content(json)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateArtifactErrorWithNonExistentId() throws Exception{
        ...
        given(artifactService.update(eq("1250808601744904192"), Mockito.any(Artifact.class)))
                .willThrow(new ObjectNotFoundException("Artifact", artifactDTO.id()));
    ...
    void testDeleteArtifactSuccess() throws Exception{
        ...
        // When and Then
        mockMvc.perform(MockMvcRequestBuilders.delete(baseUrl + "/artifacts/1250808601744904192")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testDeleteArtifactNotFound() throws Exception{
        // Given
        doThrow(new ObjectNotFoundException("Artifact", "1250808601744904192")).when(artifactService)
